...
# ── FUNÇÕES COM CACHE (agora TTL de 1 hora) ─────────────────────────────────
    ...
    <head>
        ...
        <style>
            *, *::before, *::after {{ margin:0; padding:0; box-sizing:border-box; }}
            ...
            .header-deco {{
                font-size:1.2rem; letter-spacing:4px; margin-top:8px; opacity:0.6;
            }}
            .header-count {{
                margin-top:8px; font-size:0.85rem; color:#475569;
                background:rgba(241,245,249,0.8); border-radius:20px;
            ...
            .polaroid-container {{ width:100%; display:flex; align-items:center; justify-content:center; z-index:1; }}
            .polaroid-wrapper {{ position:relative; width:100%; max-width:300px; }}
            .polaroid {{
                background:#fff; padding:16px 16px 50px; border-radius:4px;
            ...
            .nome {{
                font-family:'Playfair Display',serif;
                font-size:1.4rem; font-weight:900; margin-top:12px; color:#0f172a;
            ...
            .recados-titulo {{
                font-family:'Playfair Display',serif;
                font-size:1.5rem; font-weight:700; font-style:italic; color:#1e293b;
            ...
            .area-post-it {{ display:flex; flex-wrap:wrap; gap:16px; }}
            .post-it {{
                padding:14px 12px; width:150px; min-height:110px;
            ...
            .post-it-autor {{
                ...
                margin-top:auto; border-top:1px dashed rgba(0,0,0,0.1); padding-top:6px;
            }}
            .sem-recados {{
                color:#64748b; font-style:italic; padding:1rem 0;
            }}
    ...
    <body>
        <div class="mural-header">
            <div class="mural-header-inner">
                ...
                <h1>Aniversariantes de <span style="color:#0284c7;">{nome_mes_atual}</span></h1>
...
# ── SUB‑MURAL RETROATIVO (apenas para desktop, se aplicável) ─────────────────
